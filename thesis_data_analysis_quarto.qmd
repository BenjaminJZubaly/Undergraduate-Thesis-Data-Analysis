...
sw_results_LingObf_GorP_2 <- data_no_gpaper_obf_outlier %>%
  group_by(Genuine_or_Fraudulent) %>%
...
cat("Bootstrapped 95% Confidence Interval for F-statistic: ", boot_f_ci_obf$bca[4], " to ", boot_f_ci_obf$bca[5], "\n")
```
